...
import com.runanywhere.sdk.RunAnywhereClient
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val client = RunAnywhereClient.default()
        lifecycleScope.launch {
            try {
                val result = client.execute("print('Hello from RunAnywhere!')")
                Toast.makeText(this@MainActivity, "RunAnywhere says: $result", Toast.LENGTH_LONG).show()
            } catch (e: Exception) {
